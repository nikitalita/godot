...
private:
	...
	HashMap<String, String> _probe_system_fonts(const Vector<String> &needed_scripts, bool bold, bool italic);
...
public:
	...
	static Ref<SystemFont> load_system_font(const String &p_name, bool p_bold, bool p_italic, TextServer::Hinting p_hinting, TextServer::FontAntialiasing p_aa, bool p_autohint, TextServer::SubpixelPositioning p_font_subpixel_positioning, bool p_msdf = false, TypedArray<Font> *r_fallbacks = nullptr);
